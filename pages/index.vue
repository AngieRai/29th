      ...
      <section class="py-10">
        <v-container>
          ...
          <p>
            ...
            deleniti tenetur maxime libero unde molestiae. Veritatis fugit
            molestiae vitae laboriosam voluptatem, autem nemo blanditiis
            deserunt ex, culpa quidem ratione odio.
          </p>
          <v-btn to="/about" color="red" >SLEEP</v-btn>
        </v-container>
      </section>
    </v-app>
  </section>
